...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        if (strncmp(line, "WELCOME", 7) == 0) {
            ...
            printf("Moves format: r1 c1 r2 c2  (rows 0-%d, cols 0-%d)\n",
                   ROWS, COLS);
        }
            ...
            snprintf(movebuf, sizeof(movebuf),
                     "MOVE %d %d %d %d\n", r1, c1, r2, c2);
            write(fd, movebuf, strlen(movebuf));
        }
